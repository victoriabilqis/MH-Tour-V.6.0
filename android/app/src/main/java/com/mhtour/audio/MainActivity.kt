...
class MainActivity : ComponentActivity() {
    ...
    private fun home() {
        ...
        root.post {
            ...
            place(jamaahBtn, 0.075f, 0.582f, 0.85f, 0.085f)
            place(guideBtn, 0.075f, 0.682f, 0.85f, 0.085f)
    ...
    private fun guideScreen() {
        ...
        val talk = primaryButton(if (micEnabled) "🎙  Sedang Bicara" else "🎙  Mulai Bicara", emerald)
